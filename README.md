...
**Live demo:** _coming soon_ — open it in its own tab in a current Chrome, Edge
...
| `SITE_URL` | variable, optional | public origin for link previews, e.g. a custom domain (default `https://<project>.pages.dev`) |
